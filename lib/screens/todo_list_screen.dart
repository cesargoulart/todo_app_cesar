...
class _ToDoListScreenState extends State<ToDoListScreen> {
  ...
  void _addToDoItem(String title, {DateTime? dueDate}) async {
    if (title.isNotEmpty) {
      setState(() {
        _todos.add(ToDoItem(title: title, dueDate: dueDate));
      });
  ...
  void _editToDoItem(ToDoItem todo, String newTitle, {DateTime? dueDate}) async {
    setState(() {
      todo.title = newTitle;
  ...
  // Combined Add/Edit dialog with date and time picker
        ...
        child: Row(
          ...
          children: <Widget>[
            TextButton(
              ...
              child: Text(
                _showCompleted ? 'Hide Completed Tasks' : 'Show Completed Tasks',
